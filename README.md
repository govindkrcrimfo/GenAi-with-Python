# 🚀 Python & GenAI Learning

A structured learning repository covering Python, FastAPI, OpenAI APIs, LangChain, LangGraph, RAG, and AI application development.

## 📚 Topics Covered

* **Python Basics** – Core programming concepts such as variables, collections, loops, functions, OOP, File Handling , JSON, and async programming.
* **Pip & UV** – Python package and dependency management tools (similar to **Maven/Gradle** in Java).
* **GIL** – Python's execution lock mechanism that affects multithreading (conceptually similar to thread synchronization concerns in Java).
...
Build production-ready AI applications using Python and modern GenAI frameworks.
